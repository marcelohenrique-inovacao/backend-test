...
namespace backendtest.API.Controllers
{
    ...
    public class AutenticacaoController : MainController
    {
        ...
        public AutenticacaoController(SignInManager<IdentityUser> signInManager,
                                      ...
                                      IUser user, ICommandResult comandResult):base(user)
        {
        ...
        public async Task<ActionResult> Registrar(RegisterUserViewModel registerUser)
        {
            ...
            {
                _comandResult.AddErro("AspNetIdentity", error.Description);
                return CustomResponse(_comandResult);
            }
        ...
        public async Task<ActionResult> Login(LoginUserViewModel loginUser)
        {
            ...
            {
                _comandResult.AddErro("Usuário", "Usuário temporariamente bloqueado por tentativas inválidas");
                return CustomResponse(_comandResult);
            }

            _comandResult.AddErro("Usuário/Senha", "Usuário ou Senha incorretos");
            return CustomResponse(_comandResult);
        }
